...
import com.professionalandroid.apps.foodrecommand.R
import com.professionalandroid.apps.foodrecommand.databinding.ActivityQuestionsBinding
...
class QuestionsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.llProgressDetails.visibility = View.GONE

        mBinding.btnSubmit.setOnClickListener { v ->
            when (curQuestion) {
                0 -> {
                    mBinding.tvQuestion.visibility = View.GONE
                    mBinding.llProgressDetails.visibility = View.VISIBLE
                    setQuestion(
